...
class Settings(BaseSettings):
    ...
    MEDIASTACK_LOAD_FACTOR: float = 1
    HIGH_CRED_MIN_SIMILARITY: float = 0.65
    SENSITIVE_MIN_SIMILARITY: float = 0.75
    SENSITIVE_KEYWORDS: str = "dead|died|death|killed|assassinated|shooting|attack|explosion|bomb|massacre|terror|earthquake|flood|genocide"
    ENFORCE_WHITELIST: bool = True
    BLACKLIST_DOMAINS: str = ""
    BREAKING_KEYWORDS: str = "breaking|urgent|just in|today|now"
    FRESHNESS_SOFT_DAYS: int = 30
    FRESHNESS_HARD_DAYS: int = 180
